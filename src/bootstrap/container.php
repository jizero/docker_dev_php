...
$entires['db'] = function () {
    ...
    #$db = new PDO('mysql:host=database;dbname=mydb;charset=utf8mb4', 'root', 'jizero');
    ...
    $connection->addConnection([
        ...
        'password' => getenv('DB_PASSWORD') ?: 'jizero',
        'charset' => 'utf8mb4',
...
$entires['replica'] = function () {
    ...
    $connection->addConnection([
        'driver' => 'mysql',
        'host' => getenv('RE_DB_HOST') ?: 'database',
        'database' => getenv('RE_DB_NAME') ?: 'mydb',
        'username' => getenv('RE_DB_USER') ?: 'root',
        'password' => getenv('RE_DB_PASSWORD') ?: 'jizerotest123#',
        'charset' => 'utf8mb4',
        'collation' => 'utf8_unicode_ci',
        'prefix' => '',
        'unix_socket' => getenv('RE_DB_UNIX_SOCKET') ?: null,
    ]);
